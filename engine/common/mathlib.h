...
#define VectorNormalize( v ) { float ilength = (float)rsqrt(DotProduct(v, v));/*if (ilength) ilength = 1.0f / ilength;*/v[0] *= ilength;v[1] *= ilength;v[2] *= ilength; }
...
#define _VectorScale VectorScale // compability
