...
void SIMD_VectorNormalize( vec3_t a );
void SIMD_VectorNormalize2( const vec3_t a, vec3_t dst );
void SIMD_VectorNormalizeFast( vec3_t a );
float SIMD_VectorNormalizeLength( vec3_t a );
...
int SIMD_VectorIsNull( const vec3_t v );
